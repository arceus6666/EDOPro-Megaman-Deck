...
function s.initial_effect(c)
  ...
  Synchro.AddMajesticProcedure(c, aux.FilterBoolFunction(Card.IsCode, CYBER_ELFS.CREA), true,
    aux.FilterBoolFunction(Card.IsCode, CYBER_ELFS.PREA), true, Synchro.NonTunerEx(Card.IsSetCard, ARCHETYPES.CYBER_ELF)
    , false)
